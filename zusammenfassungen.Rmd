...
# Jaehrliche Zusammenfassungen {.tabset .tabset-fade .tabset-pills}

2022 bezieht sich immer auf den gegenwaertigen Stand linear extrapoliert auf das ganze Jahr.
...
axis(1, at = seq(0, 10 ^ 6, by = 20000), labels = format(seq(0, 10 ^ 6, by = 20000), scientific = FALSE))
for (i in 1:nrow(km)){lines(xs, ys[i, ], type = "b", col = i + 1, lwd = 2)}
...
plot(0, 0, type = "n", xlim = c(1, 12), ylim = c(0, 150000), xlab = "", ylab = "", main = "Kumulativer Aufstieg", xaxt = "n", yaxt = "n")
...
# Pro Jahr {.tabset .tabset-fade .tabset-pills}
...
# Pro Woche {.tabset .tabset-fade .tabset-pills}
